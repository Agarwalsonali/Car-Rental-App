...
const Hero = () => {
    ...
    const {pickupDate, setPickupDate, returnDate, setReturnDate, nav} = useAppContext()

    const handleSearch = (e)=>{
      e.preventDefault()
      nav('/cars?pickupLocation=' + pickupLocation + '&pickupDate=' + pickupDate + '&returnDate=' + returnDate)
    }
